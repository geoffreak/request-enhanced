...
(function() {
  var Heap, defaults, fs, get, getFile, getHelper, getRequest, heap, mkdirs, popStuff, request, running,
    __slice = [].slice;
  ...
  get = function(options, regex, callback) {
    ...
    options = {
      timeout: typeof options === 'object' && (options.timeout != null) ? options.timeout : defaults.timeout,
      maxAttempts: typeof options === 'object' && (options.maxAttempts != null) ? options.maxAttempts : defaults.maxAttempts,
      pool: typeof options === 'object' && (options.pool != null) ? options.pool : defaults.pool,
      ...
      for (key in regex) {
        ...
        if (!regexp.global) {
          if (!(search.results != null)) {
            ...
            results[key] = result || defaultValue;
          ...
          for (i = _i = 0, _len = _ref1.length; _i < _len; i = ++_i) {
            ...
            if (!(search.results != null)) {
              ...
              results[key][i] = inner || defaultValue;
            } else if (typeof search.results === 'number') {
